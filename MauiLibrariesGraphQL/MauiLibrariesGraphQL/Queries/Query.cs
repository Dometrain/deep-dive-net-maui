namespace MauiLibrariesGraphQL;

public class Query
{
	[GraphQLDescription("Returns all libraries")]
	public List<LibraryModel> GetLibraries() => CreateLibraries();

	[GraphQLDescription("Returns all libraries")]
	public LibraryModel GetLibrary(string title) => CreateLibraries().Single(x => x.Title == title);

	static List<LibraryModel> CreateLibraries() => new List<LibraryModel>
	{
		new()
		{
